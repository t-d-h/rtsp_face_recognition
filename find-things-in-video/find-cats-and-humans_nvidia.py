...
def download_yolo_files():
    ...
    files = {
        "yolov3.weights": "https://onboardcloud.dl.sourceforge.net/project/yolov3.mirror/v8/yolov3.weights",
...
# Check if CUDA is available and set the backend
...
# --- Video File ---
if len(sys.argv) != 2:
    print("Usage: python find-cats-and-humans_nvidia.py <video_file_path>")
    sys.exit()
